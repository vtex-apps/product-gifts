...
| `nameType` | `enum` | By default the sku name associated with the product is displayed, otherwise you can choose to display the product name using `productName` as value. | `skuName`       |
